...
import Corner from 'material-ui/svg-icons/action/rounded-corner';
...
const data = {
  menus: [
    ...
    { text: 'Room A DashBoard', icon: <Room/>, link: '/roomDashboard' },
    { text: 'Overall DashBoard', icon: <Corner/>, link: '/overallDashboard' },
